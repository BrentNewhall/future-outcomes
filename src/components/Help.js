    ...
    render() {
        return( 
            ...
            <div className="container">
              ...
              <p>There's one special Outcome: <em>hurt</em>. You can be hurt multiple times! There's a progress bar to track your hurt; tap the + or - buttons to add or remove hurt.</p>T
            </div>
          </div>
        )
    }
